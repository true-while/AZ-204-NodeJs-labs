...
in the following steps you will build storage account for storing images and Web API app to retrieve and upload images. Finlay you will deploy Web App to provide UI to the Web API service.

![schema](../../images/lab01schema.png)
...
1.  From the **Basics** tab, perform the following actions:
    ...
    1.  In the **Runtime stack** drop-down list, select the latest Node version, eg **Node 12 (LTS)**.
...
#### Task 6: Deploy an Node.js web application to Web Apps
...
1.  In the editor, in the **ImagesController** class on line 7, observe the **list_all_img** method and the code used to retrieve a images list.

1.  In the **blobrepo.js** class on line 8, observe the **Init** method to initialize the container client. The method called from **app.js**. Then on line 21 the code used to retrieve all blobs asynchronously from the **images** container. Finlay line 14 observe the **UploadFile** method to upload file in the container.

1.  In the **ImagesController** class on line 11, observe the **create_a_img** method and the code used to persist an uploaded image to  Storage and call **UploadFile** from **blobrepo.js**

1.  On the taskbar, select the **Windows Terminal** icon. Alternatively you can use CloudShell. 

1.  At the open command prompt (skip this step for CloudShell), enter the following command, and then select Enter to sign in to the Azure Command-Line Interface (CLI):
...
In this exercise, you created a web app in Azure and then deployed your Node.js web application to Web Apps by using the Azure CLI and Apache Kudu zip file deployment utility.
...
1.  From the **Basics** tab, perform the following actions:
    ...
    1.  In the **Runtime stack** drop-down list, select the latest Node version, eg **Node 12**.
...
#### Task 3: Deploy an Node.js express web application to Web Apps
